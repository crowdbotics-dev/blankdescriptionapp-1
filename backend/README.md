...
## Project Structure
    ...
    ├── blankdescriptionapp_1  # Django project configurations
...
1. Clone this repo and `cd blankdescriptionapp_1`
...
2. Clone this repo and `cd blankdescriptionapp_1`
